...
export class OpenAI {
    ...
    constructor({ baseURL = readEnv('OPENAI_BASE_URL'), apiKey = readEnv('OPENAI_API_KEY'), organization = readEnv('OPENAI_ORG_ID') ?? null, project = readEnv('OPENAI_PROJECT_ID') ?? null, webhookSecret = readEnv('OPENAI_WEBHOOK_SECRET') ?? null, ...opts } = {}) {
        ...
        if (apiKey === undefined) {
            throw new Errors.OpenAIError('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');
        }
        const options = {
            apiKey,
            organization,
